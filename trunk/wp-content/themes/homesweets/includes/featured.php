		...
		global $post; ?>
			...
			<?php if ( $et_slider_type == 'cycle' ) { ?>
				<div class="slide">
					...
					<div class="featured-description">
						...
						<a href="<?php the_permalink(); ?>" class="readmore"><?php esc_html_e('Xem thêm', 'Chameleon'); ?></a>
			...
			<?php if ( $et_slider_type == 'roundabout' ) { ?>
				...
				<div class="slide<?php echo $et_slide_class; ?>">
					...
					<a class="featured-link" href="<?php echo $et_link; ?>"><?php esc_html_e('Xem thêm','Chameleon'); ?></a>
