...
session_start();
/*
Template Name: page-register-page-03
Css: page_03.css - header
*/
?>
...
<?php
	function checkEmailExists($email){
		$exists = 0;
		$url_domain = 'http://ezsolution.vn:8180/EzRest/rest/web';
...
<?php
	...
	if(isset($_POST['et_contact_reset_ph'])){
	...
	if ( isset($_POST['et_register_form_submit_ph']) || isset($_POST['et_contact_reset']) || isset($_POST['register_submit_form_ph'])) {
...
<div id="content" class="clearfix<?php if($fullwidth) echo(' fullwidth');?>">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		<div id='dk_page_03'>
			<!--
			<div id='logo_ez_dk'>
				<img src="<?php bloginfo('template_url'); ?>/images/maybanhang_logo_251x44.png">
			</div>
			<!-- id='logo_ez_dk -->
