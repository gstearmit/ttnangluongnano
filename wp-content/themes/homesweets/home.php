	...
	<?php if ( get_option('chameleon_blog_style') == 'false' ) { ?>
		...
		<?php if ( get_option('chameleon_display_media') == 'on' ) { ?>
			<div id="multi-media-bar">
				<h3 class="title"><?php esc_html_e('Khách hàng','Chameleon'); ?></h3>
				<div id="et-multi-media" class="clearfix">
					<a id="left-multi-media" href="#"><?php esc_html_e('Trước','Chameleon'); ?></a>
					<a id="right-multi-media" href="#"><?php esc_html_e('Tiếp','Chameleon'); ?></a>
					<div id="media-slides">
						<?php 
							$args=array(
