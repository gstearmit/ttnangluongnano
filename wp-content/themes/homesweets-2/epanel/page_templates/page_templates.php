...
function et_ptemplate_save_details( $post_id, $post ){
	...
	if ( !in_array( $_POST["page_template"], array('page-blog.php', 'page-sitemap.php', 'page-gallery.php', 'page-search.php', 'page-login.php', 'page-contact.php', 'page-template-portfolio.php','page-register_dk.php','page-dangki-chuan.php','page-thudangki.php') ) )
		return $post_id;
